...
const Card: React.FC<CardProps> = ({ title, description, image, counter }): JSX.Element => {
  return (
    <div className={`relative overflow-hidden border-2 px-28 py-2 border-emerald-400 rounded bg-gray-900 flex flex-col justify-center items-center ${counter === 2 ? "col-span-2" : ""}`}>
