...
const About = (): JSX.Element => {
  ...
  return (
    <section id="aboutME" className="w-full max-h-dvh lg:px-28 py-20 md:py-24  px-4  flex  lg:flex-row flex-col justify-center lg:justify-normal items-center gap-14 bg-slate-900 mt-40 md:mt-10">
      {/* context */}
